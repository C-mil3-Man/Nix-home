  ...
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      bind d display-menu -T "#[align=centre]Dotfiles" -x C -y C \
        "NixOS flake.nix"        f  "display-popup -E 'nvim ~/nix-home/flake.nix'" \
        "NixOS core packages"    c  "display-popup -E 'nvim ~/nix-home/modules/packages.nix'" \
        "       Exit"              q  ""
